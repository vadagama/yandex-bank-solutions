...
- [Задание 1. MVP процесса открытия депозитов в интернет-банке](task-1/ADR-mvp-deposit.md) — описание первого шага по автоматизации открытия депозитов в интернет-банке.
- [Задание 2. Открытие депозита через отделение](task-2/ADR-branch-deposit.md) — решение по доработке оффлайн-процесса открытия депозитов в отделениях.
- [Задание 3. Автоматизация открытия депозита](task-3/ADR-automation-deposit.md) — архитектурное обоснование полного автоматизированного сценария открытия депозитов.
