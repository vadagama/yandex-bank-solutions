...
- [Задание 3. Проект автоматизации открытия депозитов онлайн](task-3/ADR-automation-deposit.md) — решение по реализации автоматизированной подачи и обработки заявок на депозит через интернет-банк.
