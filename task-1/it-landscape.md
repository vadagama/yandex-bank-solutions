...
### IT-ландшафт банка «Стандарт»

![IT-Landscape.png](IT-Landscape.png)

В формате draw.io: [IT-Landscape.drawio](IT-Landscape.drawio)

### Текущая диаграмма интеграции приложений

На диаграмме интеграции приложений для компании "Стандарт" отображаются категории пользователей, которые работают с системами. Это помогает увидеть контекст, который приводит к интеграциям и с другой стороны показывает влияние на бизнес-процессы.

![app-integrations.png](app-integrations.png)

В формате plantUML: [app-integrations.puml](app-integrations.puml)
